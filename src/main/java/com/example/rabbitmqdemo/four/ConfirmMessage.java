...
//        ConfirmMessage.publishMessageIndividually();//发布1000单个确认消息，耗时33469ms
//        ConfirmMessage.publishMessageBatch();//发布1000批量确认消息，耗时816ms
        ConfirmMessage.publishMessageAsync();//发布1000异步发布确认消息，耗时178ms
    }
    ...
    public static void publishMessageAsync() throws IOException, TimeoutException {
        ...
        //结束时间
        long end = System.currentTimeMillis();
        System.out.println("发布" + MESSAGE_COUNT + "异步发布确认消息，耗时" + (end - begin) + "ms");
    }
}
